...
log4j = {
    ...
    //}
    appenders {
        rollingFile name:"logfile", maxFileSize:1000000, file:"/var/log/bigbluebutton/bigbluebutton-lti.log", layout:pattern(conversionPattern: '%d{[dd.MM.yy HH:mm:ss.SSS]} %-5p %c %x - %m%n')
